...
def process_and_save_candidates(job_role):
 ...
 with open('C:\\Users\\Keertisuryawanshi\\Desktop\\Python\\evaluation_system\\kmeans_model.pkl', 'rb') as file:  # Update this path
 ...
 #     print(candidates_df[['Owner Display Name', 'Owner Reputation', 'Gold Badges', 'Silver Badges', 'Bronze Badges', role + ' Count']], "\n")
 #     candidates_df.to_csv(f'{role}122.csv', index=False)
